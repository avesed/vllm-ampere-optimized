    ...
    def __init__(
        ...
        if speculative_config is not None:
            ...
            if self.use_eagle:
                ...
                # DFlash/DSpark parallel drafters do not read ahead mid-prefill
                # and take no prefix-cache block drop, so their prefill shift is
                # 0 (requires_eagle_cache_drop is False for them).
